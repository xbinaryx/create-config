...
## [2.0.0](https://github.com/xbinaryx/create-config/compare/v1.10.0...v2.0.0) (2025-09-03)
...
* add TypeScript config file support ([#181](https://github.com/xbinaryx/create-config/issues/181)) ([04935f1](https://github.com/xbinaryx/create-config/commit/04935f1b001bea3867a5d6b03aabb281256da53f))
...
* remove double blank lines when not use eslintrc style ([#185](https://github.com/xbinaryx/create-config/issues/185)) ([c2de1f7](https://github.com/xbinaryx/create-config/commit/c2de1f71d95bc66902e07c35a0f0ab644382ab0e))
